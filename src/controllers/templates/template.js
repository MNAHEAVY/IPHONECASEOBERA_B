                                          ...
                                          <tr>
                                              <td>
                                                  <table class="m_-5006345486347126279row-content" align="center"
                                                      ...
                                                      style="background-color:#363636;color:#333;width:650px"
                                                      width="650">
                                                      <tbody>
                                                          <tr>
                                                                          ...
                                                                          <tr>
                                                                              <td
                                                                                  ...
                                                                                  <div style="line-height:10px"><img
                                                                                          ...
                                                                                          style="display:block;height:auto;border:0;width:68px;max-width:100%"
                                                                                          width="195" alt="Image"
                                                                                          title="Image"></div>
                                                                              </td>
                                                                          </tr>
                                                                          ...
                                                                          <tr>
                                                                              <td
                                                                                  ...
                                                                                  <h1
                                                                                      ...
                                                                                      <span></span>Iphone Case Obera</h1>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
                                          ...
                                          <tr>
                                              <td>
                                                  <table
                                                      ...
                                                      align="center" border="0" cellpadding="0" cellspacing="0"
                                                      role="presentation"
                                                      style="background-color:#000;color:#000;width:650px"
                                                      width="650">
                                                      <tbody>
                                                          <tr>
                                                              <td class="m_-5006345486347126279column" width="100%"
                                                                                      ...
                                                                                      <div
                                                                                              ...
                                                                                              <span
                                                                                                  style="font-size:38px"><strong><span
                                                                                                          style="font-size:38px"><span
                                                                                                              style="color:#fff;font-size:38px">Tu Compra
                                                                                          ...
                                                                                          <p
                                                                                              ...
                                                                                              <span
                                                                                                  style="font-size:38px"><strong><span
                                                                                                          style="font-size:38px"><span
                                                                                                              style="color:#fff;font-size:38px">Ha sido
                                                                                                          </span><span
                                                                                                              style="color:#fff;font-size:38px">confirmada!</span></span></strong></span>
                                                                                          </p>
                                                                                      </div>
                                                                                  </div>
                                                                              </td>
                                                                                  ...
                                                                                  <div style="font-family:sans-serif">
                                                                                      <div
                                                                                          ...
                                                                                          <p
                                                                                              style="margin:0;font-size:14px;text-align:center">
                                                                                              <span
                                                                                                  style="font-size:22px">Gracias por eligir
                                                                                                  IPHONECASEOBERA</span></p>
                                                                                      </div>
                                                                                  </div>
                                                                              </td>
                                                                          </tr>
                                                                  ...
                                                                  <table width="100%" border="0" cellpadding="10"
                                                                      ...
                                                                      <tbody>
                                                                          <tr>
                                                                              <td>
                                                                                  <div align="center">
                                                                                      <a href="https://iphonecaseobera.com/"
                                                                                          style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#fc7318;border-radius:15px;width:auto;border-top:1px solid #fc7318;font-weight:400;border-right:1px solid #fc7318;border-bottom:1px solid #fc7318;border-left:1px solid #fc7318;padding-top:5px;padding-bottom:5px;font-family:Lato,Tahoma,Verdana,Segoe,sans-serif;text-align:center;word-break:keep-all"><span
                                                                                              style="padding-left:20px;padding-right:20px;font-size:18px;display:inline-block;letter-spacing:normal"><span
                                                                                                  style="font-size:16px;line-height:2;word-break:break-word"><span
                                                                                                      ...
                                                                                                      <strong>Seguir comprando </strong></span></span></span></a>
                                                                                  </div>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
                                                                                  ...
                                                                                  <div style="font-family:sans-serif">
                                                                                      <div
                                                                                          ...
                                                                                          <p
                                                                                              ...
                                                                                              <strong><span
                                                                                                      style="font-size:20px">Tu compra:</span></strong>
                                                                                          </p>
                                                                                      </div>
                                                                                  </div>
                                                                              </td>
                                                                              ...
                                                                              <div style="font-family:sans-serif">
                                                                                  <div
                                                                                      ...
                                                                                      <p
                                                                                          ...
                                                                                          <span
                                                                                              style="font-size:10px;color:#2190e3"><strong></strong></span>
                                                                                      </p>
                                                                                          ...
                                                                                          <p
                                                                                              ...
                                                                                              <span
                                                                                                  style="font-size:34px"><span
                                                                                                      style="font-size:34px"><span
                                                                                                          style="color:#fc7318"><strong>Tienes alguna duda?</strong></span></span></span>
                                                                                          </p>
                                                                                          <p
                                                                                              style="margin:0;font-size:12px;text-align:center">
                                                                                              &nbsp;</p>
